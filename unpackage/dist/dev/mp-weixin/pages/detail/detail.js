...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./pages/detail/detail.vue */ 126));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
var _default =
{
  ...
  methods: {
    getCartList: function getCartList() {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  _this.$u.api.getCartList());case 2:res = _context.sent;
                _this.cartCount = res.data.length;case 4:case "end":return _context.stop();}}}, _callee);}))();
    },
    collectGood: function collectGood() {var _this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                  _this2.$u.api.isCollect(_this2.good.id));case 2:
                if (_this2.starColor == '') {
                  _this2.$u.toast("收藏成功");
                  _this2.good.is_collect = 1;
                } else {
                  _this2.$u.toast("取消成功");
                  _this2.good.is_collect = 0;
    ...
    getGoodsDetail: function getGoodsDetail(id) {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var good;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
                  _this3.$u.api.getGoodsDetail(id));case 2:good = _context3.sent;
                _this3.good = good.goods;
                _this3.count = good.goods.comments.length;
                _this3.likegoods = good.like_goods;case 6:case "end":return _context3.stop();}}}, _callee3);}))();
    },
    addToCart: function addToCart() {var _this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                  _this4.$u.api.addToCart({ goods_id: _this4.good.id }));case 2:
                _this4.$u.toast("添加成功");
